...
t('redacts ghs_ and ghu_ tokens', () => {
  const out = redact('ghs_' + 'a'.repeat(36) + ' ghu_' + 'B1'.repeat(18));
  assert.ok(!out.includes('ghs_a'), out);
  assert.ok(!out.includes('ghu_B'), out);
});
